...
var ImageCard = React.createClass({
  ...
  handleTagOverlayClick: function () {
    ...
    let localImage = this.props.image.is_local || false;
    if (localImage) {
      tagActions.localTags(this.props.image.namespace + '/' + this.props.image.name, this.props.image.tags);
    } else {
    ...
    if (this.props.image.is_local) {
      ...
      overlay = (
        <div className="overlay menu-overlay">
          ...
          <p className="small">Prior to delete,<br/>stop all containers using this tag</p>
